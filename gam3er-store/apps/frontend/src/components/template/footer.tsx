import { IconBrandWhatsapp, IconBrandYoutube, IconBrandInstagram, IconBrandFacebook, IconBrandLinkedin } from "@tabler/icons-react";
        ...
        <div className="flex flex-col md:flex-row items-center gap-1.5 justify-between">
          ...
          <div className="flex flex-col md:flex-row items-center gap-1.5 text-sm text-zinc-500">
            <div className="flex gap-1.5">
              <span>Feito com</span>
              <span>❤️ por</span>
              <Link href="https://github.com/paulosantana95">
